...
import { LaTercera, LaTerceraSabado } from '@labcon/copesa-logos'
import Por from '../Por'
...
const Custom2022Widget = ({ bgColor = '#eaeaea' }) => {
  return (
    <Wrap>
      <LogoWrap>
        <LogoBox className="logobox" mainColor={'#f05a5c'} />
        <LogoWide className="logowide" mainColor={'#f05a5c'} />
      </LogoWrap>
      <RestWrap bgColor={bgColor}>
        <SectionWrap>
          <Section className="ltpm">
            <LaTerceraSabado schema="common" version="small" />
          </Section>
        </SectionWrap>
        <Presented>
          {/* <PresentedWrap>
