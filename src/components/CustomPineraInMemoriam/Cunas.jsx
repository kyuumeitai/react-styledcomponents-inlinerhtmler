...
const Cuna = () => {
  return (
    <div>
      <Quote
        text="Nos acompañan en este equipo de ministros y ministras, personas de diversos orígenes y generaciones, como diverso es nuestro país porque estamos seguros que la riqueza de Chile radica justamente en la diversidad de su gente"
        author="21 de enero de 2022. Discurso de presentación de gabinete"
        size="small">
        <Sharer
          url="https://www.latercera.com/el-gabinete-de-gabriel-boric/"
          description={`"Nos acompañan en este equipo de ministros y ministras, personas de diversos orígenes y generaciones, como diverso es nuestro país porque estamos seguros que la riqueza de Chile radica justamente en la diversidad de su gente"
  
El gabinete de Gabriel Boric - La Tercera`}
          hashtags="Gabinete,GabineteBoricLT"
...
Gabriel Boric Font - Presidente Electo de Chile - La Tercera`}
      ...
      {/* <Quote
        text="Recibo este mandato con humildad. Sé que en los años que vienen se juega el futuro de nuestro país. Por eso les garantizo desde ya que seré un presidente que cuide la democracia y no la exponga, que escuche más de lo que habla; que busque la unidad de los acuerdos y que atienda, día a día, a las necesidades de las personas; que combata los privilegios y trabaje cada día por la calidad de vida de tu familia"
        author="19 de diciembre de 2021. Primer discurso tras haber sido <strong>electo presidente de la República.</strong>"
        size="smaller">
        <Sharer
          url="https://www.latercera.com/gabriel-boric-presidente-chile/"
          description={`"Recibo este mandato con humildad. Sé que en los años que vienen se juega el futuro de nuestro país. Por eso les garantizo desde ya que seré un presidente que cuide la democracia y no la exponga, que escuche más de lo que habla; que busque la unidad de los acuerdos y que atienda, día a día, a las necesidades de las personas; que combata los privilegios y trabaje cada día por la calidad de vida de tu familia"
