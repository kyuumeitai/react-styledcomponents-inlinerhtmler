        ...
        <div className="meta-layer">
          <div className="title-wrapper">
            ...
            <div className="info-wrapper">
              <div className="supplemental h-m">Preestreno exclusivo para suscriptores</div>
              <p className="synopsis h-m">
                Desentrañamos la mente de los creadores para entender el punto exacto donde aparece la creación.<br />
                Dirigida por Fernando Lavanderos.
              </p>
              <div className="video-actions">
                <a className="btn-action btn-action-solid" href="https://suscripciondigital.latercera.com/">
                ...
                <a className="btn-action btn-action-transparent" href="https://www.latercera.com/login/">
                  {/* <div className="btn-icon">
