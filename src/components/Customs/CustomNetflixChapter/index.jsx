        ...
        <div className="chapter available">
          <a
            ...
            <div className="chapter-img">
              <img
                src="https://cloudfront-us-east-1.images.arcpublishing.com/copesa/ZYVAUS6LAZAGFEIHHSOXBICXTU.jpg"
                alt=""
              />
            </div>
            ...
            <div className="chapter-iframe">
              <div className="video-proportion-16by9">
                <video
                  src="https://rudo.video/redirector/320/ccc2162da35f15c11df3d9a78dc2a691.mp4"
                  muted={true}
                  autoPlay={true}
                  playsInline={true}
                  preload="auto"
