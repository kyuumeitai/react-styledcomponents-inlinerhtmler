  ...
  const data = [
    {
      ...
      img:
        'https://cloudfront-us-east-1.images.arcpublishing.com/copesa/X262HLKIVZCEHIUNH32QWWFAAQ.jpg',
    ...
    },
    {
      ...
      img:
        'https://cloudfront-us-east-1.images.arcpublishing.com/copesa/33URTPQE4ZADVN6KBJQWLDCUMI.jpg',
      status: ['past', 'available'],
      pretitle: 'Capítulo 02',
      name: 'Susannah Buchan',
      title: 'Oceanógrafa',
      preview:
        'https://ads-lt.digitalproserver.com/ads/lab/preview-02-comp.mp4',
      label: 'Disponible',
    },
    {
      url: 'https://www.latercera.com/asi-empieza/03-paulina-villalobos/',
      img:
        'https://cloudfront-us-east-1.images.arcpublishing.com/copesa/57MLVKMOCZFBRMVAX6TG42DB6M.jpg',
      status: ['past', 'available'],
      pretitle: 'Capítulo 03',
      name: 'Paulina Villalobos',
      title: 'Lightning Designer',
      preview:
        'https://ads-lt.digitalproserver.com/ads/lab/preview-03-comp.mp4',
      label: 'Disponible',
    },
    {
      url: 'https://www.latercera.com/asi-empieza/04-alex-anwandter/',
      img:
        'https://cloudfront-us-east-1.images.arcpublishing.com/copesa/HVHEUPDXNZDJFN7SWRBCGEFDTY.jpg',
      status: ['available'],
      pretitle: 'Capítulo 04',
      name: 'Alex Anwandter',
      title: 'Cantautor',
      preview:
        'https://ads-lt.digitalproserver.com/ads/lab/preview-04-comp.mp4',
      label: 'Disponible',
    },
    {
      url: 'https://www.latercera.com/asi-empieza/05-caiozzama/',
      img:
        'https://cloudfront-us-east-1.images.arcpublishing.com/copesa/75WFR6WBQ5BCZDB6DRRQDKRTZU.jpg',
      status: ['available'],
      pretitle: 'Capítulo 05',
      name: 'Caiozzama',
      title: 'Artista',
      preview:
        'https://ads-lt.digitalproserver.com/ads/lab/preview-05-comp.mp4',
      label: 'Disponible',
    },
    {
      url: 'https://www.latercera.com/asi-empieza/06-francisca-valenzuela/',
      img:
        'https://cloudfront-us-east-1.images.arcpublishing.com/copesa/3OM2XBFXBNBTJGN4VDLAZO3XUE.jpg',
      status: ['top', 'new', 'available'],
      pretitle: 'Capítulo 06',
      name: 'Francisca Valenzuela',
      title: 'Cantautora',
      preview:
        'https://ads-lt.digitalproserver.com/ads/lab/preview-06-comp.mp4',
      label: 'Nuevo',
    },
    {
      url: 'https://www.latercera.com/asi-empieza/07-alejandro-zambra/',
      img:
        'https://cloudfront-us-east-1.images.arcpublishing.com/copesa/GUWYUPCS2BDI3C5KAHJ7SAHIHI.jpg',
      status: ['top', 'new', 'available'],
      pretitle: 'Capítulo 07',
      name: 'Alejandro Zambra',
      title: 'Escritor',
      preview:
        'https://ads-lt.digitalproserver.com/ads/lab/preview-07-comp.mp4',
      label: 'Nuevo',
    },
  ]
    ...
    <WrapMenu className={`${chapters ? `wrapchapters-${chapters}` : ''}`}>
      <div
        className={`hero-chapters ${
          chapters ? 'withchapters-' + chapters : ''
        }`}>
        {data.map((chapter, index) => {
          if (!show || (show && chapter.status.includes(show))) {
            return (
              <div
                className={`chapter ${chapter.status.join(' ')}`}
                key={index}>
