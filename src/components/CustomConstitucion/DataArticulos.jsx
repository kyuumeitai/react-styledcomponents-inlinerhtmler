const data = [
  {
    ...
    aprobado: `Rechazada`,
    fecha: `16/02/2022`,
    textodefinitivo: `Atribuciones de la Asamblea Regional. Son atribuciones de la Asamblea Regional, en conformidad a la Constitución, la ley y el Estatuto Regional:
