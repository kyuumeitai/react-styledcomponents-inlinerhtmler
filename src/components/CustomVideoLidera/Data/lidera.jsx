...
const metadata = {
  ...
  title: 'Lidera Paula',
  supplemental:
    '<small>Mujeres, trabajo y nuevos liderazgos</small> <br /><br />Disponible Capítulo 10: <br />María Ana Matthias',
  ...
  mainlink: 'https://www.latercera.com/lidera/10-maria-ana-matthias/',
  secondarylink:
...
const data = [
  ...
  },
  {
    ...
    preview:
      'https://ads-lt.digitalproserver.com/ads/lab/lidera-paula/prev-cap02-comp.mp4',
    label: 'Disponible',
    description: `<p>En esta conversación, la experta en asuntos corporativos y sostenibilidad, y socia fundadora de REDMAD, Teresa Matamala, habla sobre las brechas de género en el mundo empresarial y explica por qué encontramos a menos mujeres en la medida que vamos subiendo de rango en las organizaciones. </p>

    <p>Según explica, los puestos de alta dirección implican una alta demanda de tiempo, que -por cómo concebimos los cuidados hoy- muchas mujeres no tienen. Pero la pandemia nos ha obligado a revisar estas desigualdades, así como buscar alternativas que favorezcan la inclusión y desarrollo profesional. ¿Qué hay que hacer para cambiar esta realidad? ¿Qué políticas se tienen que impulsar desde el sector privado para asegurar una equidad en materia de género? ¿Cómo se articulan el sector público y privado para encontrar soluciones a corto plazo?</p>`,
    iframe: 'https://rudo.video/vod/bOvquc',
...

  {
    ...
    label: 'Disponible',
    description:
      '<p>La astrónoma y académica del departamento de Astronomía de la Universidad de Chile, Laura Pérez, conversó con la periodista Emiliana Pariente sobre cómo integrar la ciencia al relato social, el rol de la academia en acercar esta disciplina a la ciudadanía y la importancia de tener referentes para incentivar el desarrollo integral de estos rubros. Además, habló sobre los fenómenos astronómicos recientes, la descentralización de la ciencia y la importancia de la colaboración en el mundo de la investigación.</p>',
    iframe: 'https://rudo.video/vod/bO2H3e',
...

  {
    ...
    label: 'Disponible',
    description:
      'En este capítulo, la vicepresidenta de McCann y de REDMAD, Maribel Vidal, rescata la importancia de los liderazgos modernos, horizontales y que son capaces de generar espacios de confianza, especialmente en momentos de crisis. Es enfática al decir que las habilidades y características de liderazgo son agnósticas de género y que lo que distingue a un buen liderazgo es la capacidad de leer el entorno, darse el tiempo para escuchar y, sobre todo, cuestionar constantemente los propios sesgos. Los desafíos para los líderes de aquí en adelante tienen que ver, como explica, con lograr generar políticas que resguarden la flexibilidad laboral y el trabajo híbrido basado en la confianza. “Tenemos que ser capaces de escuchar todas las voces para encontrar la mejor solución”, dice.',
    iframe: 'https://rudo.video/vod/bO6Hww',
  ...
  },
  {
    ...
    preview:
      'https://ads-lt.digitalproserver.com/ads/lab/lidera-paula/prev-cap00-comp.mp4',
    label: 'Nuevo',
    description: `En este capítulo, la directora de empresas y de REDMAD, María Ana
    Matthias, reflexiona respecto a los beneficios y desafíos que se abren
    en el escenario de la flexibilidad laboral, un formato que ya se había
    puesto en práctica en empresas de Estados Unidos previo al 2020 pero
    cuya masificación se aceleró en la pandemia. A su vez, habla de que si
    bien la mayoría de las personas está satisfecha con esta posibilidad,
    lo que hay que abordar tiene que ver con el sistema actual de
    cuidados, que recae mayoritariamente en las mujeres y que hizo que
    fueran ellas las que tuvieran que reformular sus actividades, muchas
    veces trabajando el doble. Un estudio realizado por REDMAD así lo
    demostró; las ejecutivas de empresas del país declararon que estaban
    trabajando más horas de lo habitual y en distintos momentos del día.
    Desde el sector privado, aclara Matthias, hay que hacerse cargo;
    generar protocolos para garantizar el derecho a la desconexión, evitar
    que los colaboradores estén trabajando muchas horas, incentivar que
    más hombres se tomen el derecho al postnatal y naturalizar que los
    nuevos liderazgos sean horizontales y generen espacios de confianza.
    “La barrera entre lo laboral y lo privado se perdió. Eso tiene
    beneficios pero tiene muchos costos también, especialmente para las
    mujeres”, señala.`,
