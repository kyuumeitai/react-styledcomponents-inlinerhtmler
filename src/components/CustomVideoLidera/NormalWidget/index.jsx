...
const metadata = {
  ...
  title: 'Lidera Paula',
  supplemental:
    '<small>Mujeres, trabajo y nuevos liderazgos</small> <br />Capítulo 2: Teresa Matamala',
  synopsis:
  ...
  mainlink:
    'https://www.latercera.com/lidera/02-teresa-matamala/?utm_source=widgetLT&utm_medium=web&utm_campaign=lidera-paula',
  secondarylink:
