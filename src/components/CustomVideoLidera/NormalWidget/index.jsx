...
const metadata = {
  ...
  title: 'Lidera Paula',
  supplemental:
    '<small>Mujeres, trabajo y nuevos liderazgos</small> <br />Capítulo 8: Maribel Vidal',
  synopsis:
  ...
  mainlink:
    'https://www.latercera.com/lidera/08-maribel-vidal/?utm_source=widgetLT&utm_medium=web&utm_campaign=lidera-paula',
